...
import { fontRobotoRegular } from '@common/constants/fonts';
  ...
  return (
    <html lang="ru">
      <head>
        ...
        <link rel="mask-icon" href="/public/safari-pinned-tab.svg" color="#ffc53d" />
      ...
      <body className={fontRobotoRegular.className}>
