...
import { OrderInputStage } from '@modules/Order/components/OrderInputStage';
import { OrderStatusStage } from '@modules/Order/components/OrderStatusStage';
...
export const Order = () => {
  ...
  return (
    <Routes>
      ...
      />
      <Route path="status" element={<OrderStatusStage resetStage={resetStage} orderData={orderData} />} />
    </Routes>
  );
};
